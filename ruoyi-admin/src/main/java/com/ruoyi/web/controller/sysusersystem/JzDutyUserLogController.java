 ...
 */
@Controller
@RequestMapping("/sysusersystem/userLog")
public class JzDutyUserLogController extends BaseController
{
    private String prefix = "sysusersystem/userLog";
    ...
    @RequiresPermissions("sysusersystem:userLog:view")
    @GetMapping()
    public String user()
    {
        return prefix + "/user";
     ...
     * 查询值班关联用户列表
     */
    @RequiresPermissions("sysusersystem:userLog:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出值班关联用户列表
     */
    @RequiresPermissions("sysusersystem:userLog:export")
     ...
     * 新增保存值班关联用户
     */
    @RequiresPermissions("sysusersystem:userLog:add")
...
//        jzDutyUser.setPlanId(planId);
     ...
     * 修改保存值班关联用户
     */
    @RequiresPermissions("sysusersystem:userLog:edit")
     ...
     * 删除值班关联用户
     */
    @RequiresPermissions("sysusersystem:userLog:remove")
