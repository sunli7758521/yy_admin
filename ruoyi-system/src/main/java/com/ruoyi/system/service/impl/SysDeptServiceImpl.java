...
public class SysDeptServiceImpl implements ISysDeptService
{
    ...
    public Long selectDeptIdByDeptName(String treeName) {
        return deptMapper.selectDeptIdByDeptName(treeName);
    }
    ...
    public List<SysDept> DeptBuList(SysDept dept){
        return deptMapper.DeptBuList(dept);
    }
     ...
     */
    @Override
    public List<SysDept> systemList(Long userId) {
        return deptMapper.systemList(userId);
    }
}
